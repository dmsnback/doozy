...
#### (С настройкой отправки e-mail можно ознакомиться в документации [Яндекс](https://yandex.ru/support/mail/mail-clients/others.html) или в документации любой другой почты.)
